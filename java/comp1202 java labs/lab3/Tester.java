...
public class Tester {
    ...
    public static void testPart2c() {
        ...
        System.out.println("studentAccess is: " + lock.getstudentAccess() + "!!!!!!");
    ...
    public static void testPart3() {
        ...
        //if opening the Door before attaching the CardLock, 
        //the door should open as the isUnlocked is set to true when lock == nullit has no lock
        myDoor.openDoor();
